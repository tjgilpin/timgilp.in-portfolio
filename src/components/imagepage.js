  ...
  <React.Fragment>
    ...
    <div style={{display: 'block'}}>
      <Link to={linkage} replace>
        <span style={{ position: "fixed", right: "10px", top: "10px", zIndex: "100", fontSize: "1.65rem", background: "rgba(0, 0, 0, 0.8)", color: "rgb(255, 255, 255)", width: "2rem", height: "2rem", textAlign: "center", borderRadius: "50%" }}>×</span>
